    ...
    <BrutalistSection title="CONTACT" id="contact" accentColor="blue">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          <div className="space-y-6">
            <div className="flex gap-6">
              {['Github', 'LinkedIn', 'Twitter'].map(social => (
                <a key={social} href="https://www.edwincuenca.dev/" target="_blank" rel="noopener noreferrer" className={`text-xs border-2 border-cyber-white px-4 py-2 uppercase font-bold transition-all ${social === 'Github' ? 'hover:bg-cyber-blue hover:border-cyber-blue' :
        ...
        <div className="bg-black/60 p-6 brutalist-border border-cyber-blue font-mono">
          ...
          <TerminalPrompt label="NAME:" value="zER0 Knowledge Pr00fs" isInput />
          <TerminalPrompt label="irc:" value="" isInput />
          <TerminalPrompt label="system.out.println:" value="" isInput />
